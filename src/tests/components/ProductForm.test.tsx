...
describe('ProductForm', () => {
		...
		return {
			...
			waitForFormToLoad: async () => {
				...
				const fill = async (product: FormData) => {
					...
					await user.tab(); // -- to avoid Act warning
	...
	it('should put focus on the name field', async () => {
		// -- for this test to work, add 'autoFocus' to the TextField.Input
		const { waitForFormToLoad } = renderComponent();
	...
	it('should call onSubmit with the correct data', async () => {
		...
		// */ -- exclude id from validData to avoid comparison error on submission
	...
	it('should disable the submit button upon submission', async () => {
		const { waitForFormToLoad, onSubmit } = renderComponent();
		// -- mock the return value to a promise that isn't resolved
	...
	it('should re-enable the submit button after submission', async () => {
		const { waitForFormToLoad, onSubmit } = renderComponent();
		onSubmit.mockResolvedValue({}); // -- here returns a promise that is resolved
