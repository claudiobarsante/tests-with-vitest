...
const ProductForm = ({ product, onSubmit }: Props) => {
	...
	return (
		...
		>
			<Box>
				{/* {have to add <label></label> so the test finds the input field} */}
				{/* <label htmlFor='name'>Name</label> */}
				<TextField.Root className='max-w-sm'>
					<TextField.Input autoFocus id='name' placeholder='Name' {...register('name')} size='3' />
				</TextField.Root>
			...
			<Box>
				<Controller
					...
					render={({ field }) => (
						...
						>
							{/* {add arial-label to find the dropdown} */}
